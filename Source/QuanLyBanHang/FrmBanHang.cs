    ...
    public partial class FrmBanHang : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    using (FormInHoaDon hd = new FormInHoaDon(receiptBindingSource.DataSource as List<Receipt>, String.Format("{0:0,0}", thanhTien), DateTime.Now.ToString(), txtTenKH.Text))
                    {
                        hd.ShowDialog();
                    }
                }
